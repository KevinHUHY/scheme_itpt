...
OBJS = main.o parse.o eval_helper.o eval.o arith.o Cell.o IntCell.o DoubleCell.o SymbolCell.o ConsCell.o ProcedureCell.o
...
arith.o: eval_helper.hpp arith.hpp arith.cpp
	$(CC) -c -g -Wall -std=c++11 arith.cpp
